 ...
 */
public class setOnlineUserSettings {
    ...
    //http://www.zeeley.com/android_privacy/?hide_map_all=&hide_dist_all=&block_prof=&block_location=&block_msg=&block_invite&unblock_invite=&unblo
    // ck_location=&unblock_prof=&unblock_msg

    public static boolean setCanInvite(boolean canInvite, onlineUser user, Context context,boolean fromBlockedlist) {
        String pk = String.valueOf(user.getId());
        try {
            ...
            if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                if (canInvite) {// user exist in blockedlist.. so remove him
                    ...
                    if (list.equals(constants.DEFAULT)) {
                            blockedItem item1 = new blockedItem(user.getName(),null, (int) (user.getId()));
    ...
    public static boolean setCanMessage(boolean canMessage, onlineUser user, Context context,boolean fromBlockedlist) {
        String pk = String.valueOf(user.getId());
        try {
    ...
    public static boolean setCanViewProfile(boolean canViewProfile, onlineUser user, Context context,boolean fromBlockedlist) {
        String pk = String.valueOf(user.getId());
        try {
    ...
    public static boolean setCanAccessLocation(boolean canAccessLocation, onlineUser user, Context context,boolean fromBlockedlist) {
        String pk = String.valueOf(user.getId());
        try {
